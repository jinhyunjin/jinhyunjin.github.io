...
이 프로젝트에서 작업하기 전에 루트의 `AGENTS.md`를 끝까지 읽고 그 지침을 따른다.
...
- 변경 후 모바일과 데스크톱을 검증하고 GitHub Pages 배포 성공 여부를 확인한다.

설정, 검증, 배포 명령과 전체 디자인 원칙은 `AGENTS.md`와 `DEPLOYMENT.md`에 있다.
